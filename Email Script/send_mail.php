...
if (isset($_POST['name']) && isset($_POST['email']) && isset($_POST['msg'])) {
    ...
    try {
        ...
        $mail->Username   = 'contact@example.in';                     //SMTP username
        ...
        //Recipients
        $mail->setFrom('contact@example.in', $name);
        $mail->addAddress('Add a recipient');     //Add a recipient


        //Content
        $mail->isHTML(true);                                  //Set email format to HTML
        $mail->Subject = $name . " is Message From Portfolio.";
        $mail->Body    = $body. "<br><br> This Sender email : ".$email;
